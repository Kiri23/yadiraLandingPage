      ...
      <div class="grid mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
        ...
        <div class="flex flex-col items-start space-y-4">
          ...
          <p class="mx-auto text-gray-500 md:text-xl dark:text-white">
            At Be In Peace, I believe in a holistic and personalized approach to
            mental wellness. I am Dr. Yadira Nogueras-Rosado, and I am here to
            help you navigate life's challenges and find inner peace with
      ...
      <div className="hero min-h-screen bg-base-200">
        <div className="hero-content text-center">
          <div className="max-w-md">
            ...
            <p className="py-6">This is a Daisy UI hero component</p>
